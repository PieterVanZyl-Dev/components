...
export interface UnreleasedProps {
   ...
   */
  contentDisplayPreference?: UnreleasedProps.ContentDisplayPreference;
  /**
   * Specifies the current preference values. This includes both built-in and custom preferences.
   *
   * It contains the following:
   ...
   * - `custom` (CustomPreferenceType) - Specifies the value for your custom preference.
   */
  preferences?: UnreleasedProps.Preferences;
}

export namespace UnreleasedProps {
  export interface Preferences extends CollectionPreferencesProps.Preferences {
    contentDisplay?: ReadonlyArray<UnreleasedProps.ContentDisplayItem>;
  }
